...
def unsupervised_search(model_ori, data, ori, target, norm, args, output_size, data_max=None, data_min=None, upper = 1.0, lower = 0.0, tol = 0.000001, max_steps = 100):
    ...
    while upper-lower > tol:
        ...
        with HiddenPrints():
            lb, _, _, _ = relu_bab_parallel(copy.deepcopy(model), domain, x, batch=args.batch_size, no_LP=True,
...
save_name += (args.model + '_timeout' + str(args.timeout) + '_minibatch' + str(args.mini_batch) + '_ver_total' + str(args.ver_total))
